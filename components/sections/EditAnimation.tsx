...
const EditAnimation = () => {
  ...
  return (
    <section
      id="edit-animation"
      className="flex flex-col items-center justify-center mt-44 w-full"
    >
      <div className="flex flex-col items-center justify-center w-full relative -mb-4 sm:-mb-10">
        ...
        <div className="absolute bottom-0 w-full text-center p-4 z-10">
          ...
          <p className="text-white text-base sm:text-lg lg:text-2xl mt-1 font-semibold">
            If you're a director or editor, you can make insane visuals <br />like this, and start charging more
          </p>
        </div>
      </div>
    </section>
